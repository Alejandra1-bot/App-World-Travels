    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.centered}>
          <Text style={styles.errorText}>Administrador no encontrado</Text>
          <TouchableOpacity
    ...
    Alert.alert(
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              // TODO: implement eliminarAdministrador
              // const result = await eliminarAdministrador(administrador.id);
              // if (result.success) {
              //   navigation.goBack();
              // } else {
          ...
          <View style={styles.header}>
            <View style={styles.avatar}>
              <Text style={styles.avatarText}>
                {(administrador.nombre || administrador.Nombre || "?").charAt(0).toUpperCase()}
              </Text>
            </View>
            <View style={styles.headerText}>
              <Text style={styles.nombre}>
                {administrador.nombre || administrador.Nombre} {administrador.apellido || administrador.Apellido}
              </Text>
