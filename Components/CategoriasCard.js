...
export default function CategoriaCard({ categoria, onEdit, onDelete, userRole, onPress }) {
  ...
  return (
    <View style={styles.card}>
      <TouchableOpacity style={styles.cardContent} onPress={onPress || (() => navigation.navigate("detalleCategoria_Actividad", { categoria }))}>
        ...
        <View style={styles.details}>
          <Text style={styles.detalle}>Descripción: {categoria.Descripcion}</Text>
        </View>
      </TouchableOpacity>
