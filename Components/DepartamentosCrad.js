...
export default function DepartamentoCard({ departamento, onEdit, onDelete, userRole }) {
  const inicial = departamento.nombre ? departamento.nombre.charAt(0).toUpperCase() : "?";
    ...
    <TouchableOpacity style={styles.card}>
      ...
      <View style={styles.info}>
        ...
        <View style={styles.row}>
          <Ionicons name="earth-outline" size={16} color="#555" />
          <Text style={styles.detalle}> ID: {departamento.id}</Text>
        </View>
      </View>
